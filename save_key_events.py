...
from imagesearch.keyclipwriter import KeyClipWriter
...
url = "http://10.102.140.57:8080/shot.jpg"
...
ap.add_argument("-b", "--buffer-size", type=int, default=128,
